-- Copione del gioco
--
-- Copione estratto dalla ROM, da tradurre.
-- 
-- La chiave e' l'etichetta originale (_PalletTownText1, ...), NON la frase
-- inglese: quel testo e' contenuto della ROM del giocatore e non viene
-- ridistribuito dentro la mod.  L'inglese di riferimento sta nel worksheet
-- accanto alla cartella della mod -- vedi TRANSLATING.md, sezione "Dov'e'
-- l'inglese".
-- 
-- Tutte le voci partono vuote.  Riempi quelle che vuoi: una voce vuota
-- continua a essere disegnata in inglese, quindi la partita e' giocabile a
-- qualsiasi punto del lavoro.  Conviene cominciare dalle mappe iniziali
-- (PalletTown, ViridianCity, OaksLab) e proseguire nell'ordine in cui si
-- gioca.
-- 
-- Attenzione ai marcatori dentro il testo: {PLAYER}, {RIVAL}, {RAM:...} e
-- i caratteri di controllo (\n a capo, \f nuova pagina, \v scorri) devono
-- restare al loro posto, e il conteggio deve combaciare con l'originale --
-- altrimenti modkit rifiuta la riga.
