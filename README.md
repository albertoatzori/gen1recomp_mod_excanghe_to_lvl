...
This checkout is a modding fork: the console, mobile and handheld port trees
(`mobile/`, `ports/`, their build scripts, docs and CI jobs) were removed, so
nothing here builds or ships those targets. They live in the upstream project,
